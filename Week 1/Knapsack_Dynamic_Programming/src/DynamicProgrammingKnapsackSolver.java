 ...
 *
 */
public class DynamicProgrammingKnapsackSolver extends KnapsackSolver
{
	...
	@Override
	protected Knapsack solve(int numberOfItemsIn, int capacityIn,List<Item> itemsIn) throws Exception
	{
	...
	private Knapsack getOptimumSack() throws Exception
	{
		...
		//look in the final cell to start with
		int j = numberOfItems;
		int k = capacity;
