...
public class Vertice {
	...
	public Vertice(int idIn){
		setId(idIn);
		neighbourIDs = new HashSet<Integer>();
		neighbourColours = new HashSet<Integer>();
	}
	...
	public Set<Integer> getNeighbourColours() {
	...
	public boolean addNeighbourColour(Integer neighbourColour){
		return neighbourColours.add(neighbourColour);
	}
