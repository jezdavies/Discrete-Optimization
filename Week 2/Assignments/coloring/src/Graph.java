...
public class Graph {
	...
	public int changeVerticeColourToAnotherAvailableColour(
		...
		List<Integer>descendingDegreeNeighbourIDs = orderSubsetOfVerticeIDsByVerticeDegreeDescending(neighbourIDs);
		for(Integer i:descendingDegreeNeighbourIDs){
	...
	private List<Integer> orderSubsetOfVerticeIDsByVerticeDegreeDescending(
